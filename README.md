...
> 插件交流请加群：[798949533](https://qm.qq.com/q/pJVt8HNwrg)
...
| 图库访问令牌 | 空 | 图库接口启用鉴权后必填，进交流群获取，详见下方说明 |
...
图库接口启用令牌鉴权后，需填写「图库访问令牌」才能正常取图。令牌请进 QQ 交流群 [798949533](https://qm.qq.com/q/pJVt8HNwrg) 获取；留空则请求不携带令牌，适用于未启用鉴权的部署。
